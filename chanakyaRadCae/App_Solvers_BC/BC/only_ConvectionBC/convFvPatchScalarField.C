...
#include "convFvPatchScalarField.H"
...
Foam::convFvPatchScalarField::
convFvPatchScalarField
(
    const fvPatch& p,
...
convFvPatchScalarField
(
    const convFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::convFvPatchScalarField::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
void Foam::convFvPatchScalarField::write(Ostream& os) const
{
...
void Foam::convFvPatchScalarField::operator=
(
